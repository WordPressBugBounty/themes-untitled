...
Untitled, Copyright 2022 Refueled https://refueled.net/ Originally developed for WordPress.com.
...
Screenshot photos:
https://commons.wikimedia.org/wiki/File:F_coming_into_Smith-9th.jpeg
All other photos are from https://stocksnap.io/


Requirements
---------------

The Jetpack plugin is required in order for the featured posts slider to work:
...
* fixed slider headline text to have proper padding for multi-line headlines
* update screenshot

= 1.1.5 Sep 30 2021 =
* Untitled being maintained by refueled.net 
* Updated credits
* Updated screenshot
* CSS cleanup
